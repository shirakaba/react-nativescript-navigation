...
/**
 * @see https://github.com/react-navigation/react-navigation/blob/master/packages/stack/src/views/Header/HeaderSegment.tsx
 */
...
export default class HeaderSegment extends React.Component<Props, State> {
  ...
  render() {
    ...
    const {
      ...
      // transform,
      ...unsafeStyles
    } = customHeaderStyle as RNSStyle || {} as RNSStyle;
